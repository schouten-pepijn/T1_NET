...
class Hyperparams:
    def __init__(self):
        ...
        self.save = False
        self.train_data_path = '/home/rnga/pschouten/my-scratch/[4_6]FA_10_100_snr_NO_ref'
        # self.train_data_path = '/scratch/pschouten/SYNTH_DATA/T10_net/M0_var/4ssFA_80_snr_2_ref_angle'
